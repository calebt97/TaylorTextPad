...
private final JFrame frame;
   ...
   */
   private boolean sameOpen = false;
    private JMenuItem quit;
    private final FontBuilder fb;
   ...
   //Works in conjunction with sameOpen boolean variable.
    private static File toBeSaved;
    private CompileAndRun CandR;
   ...
   private int timesKeyPressed = 0;
    ...
    private Main() throws IOException{
        ...
        JMenuItem fileDirectory = new JMenuItem("Open File");
        fileDirectory.addActionListener(e -> openFile());
    ...
    */
    ...
    private void buildWindowListener()throws IOException {
    ...
    //Sets font
    private JComboBox buildFontLabel(){
    ...
    private void buildButtonSettings(){
        ...
        //puts them in order
        buttonsettings.setLayout(new FlowLayout(FlowLayout.LEFT));
